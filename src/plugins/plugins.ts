...
const defs: PluginDef[] = [
  {
    ...
    route: {
      path: "",
      loadComponent: () =>
        import("../sections/home/home.page").then((m) => m.HomePageComponent),
    },
  },
  {
    id: "cases",
    ...
    icon: "assignment",
    order: 1,
    route: { path: "cases", component: CasesPageComponent },
  },
  {
    id: "invoices",
    path: "invoices",
    ...
    icon: "receipt_long",
    order: 2,
    route: { path: "invoices", component: InvoicesPageComponent },
  },
  {
    id: "calendar",
    path: "calendar",
  ...
  },
  {
    ...
    icon: "mail",
    order: 4,
    route: { path: "messages", component: MessagesPageComponent },
  },
  {
    id: "documents",
    path: "documents",
    ...
    icon: "description",
    order: 5,
    route: { path: "documents", component: DocumentsPageComponent },
  },
  {
    id: "payments",
    path: "payments",
    ...
    order: 6,
    route: { path: "payments", component: PaymentsPageComponent },
  },
  {
    id: "complaints",
    path: "complaints",
    i18nKey: "nav.complaints",
    icon: "report_problem",
    order: 7,
    route: { path: "complaints", component: ComplaintsPageComponent },
  },
  {
    id: "reports",
    path: "reports",
    ...
    icon: "monitoring",
    order: 8,
    route: { path: "reports", component: ReportsPageComponent },
  },
  {
    id: "settings",
    path: "settings",
  ...
  },
  {
    ...
    route: {
      path: "integrations",
      loadComponent: () =>
        import("../shared/placeholder.page").then(
          (m) => m.PlaceholderPageComponent,
        ),
      data: { i18n: "nav.integrations" },
    },
  },
  {
    id: "support",
